...
- There are no comments to show functions purpose, parameter, return type and other stuff. 
- The menu is only displayed once, which might be problematic for short screens. 
- 
